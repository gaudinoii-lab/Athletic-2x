(() => {
  ...
  function renderHome() {
    ...
    app.innerHTML = `
      <section class="hero">
        ...
        <h1>Forte. Mobile. Atletico.</h1>
        <p>Due sedute full body, progressione graduale e recuperi senza fretta. La costanza viene prima della complessità.</p>
      </section>
      ...
      <section class="home-section">
        ...
        <div class="card">
          ...
          <div class="note">Tecnica pulita e circa <strong>2-3 ripetizioni in riserva</strong>. Se il movimento si sporca, non serve aumentare il peso.</div>
        </div>
      </section>`;
  }
  ...
  function renderHistory() {
    app.innerHTML = `
      <div class="section-title"><div><p class="eyebrow">PROGRESSIONE</p><h2>Storico</h2></div><span class="badge">${state.history.length} sedute</span></div>
      <section class="card">
  ...
  function renderSettings() {
    app.innerHTML = `
      ...
      <section class="card">
        ...
        <p class="note">La scheda è separata dal motore dell’app nel file <strong>workout-data-v3.js</strong>. Gli ID stabili degli esercizi mantengono collegati i carichi anche se in futuro cambiamo nomi, serie o ordine.</p>
      </section>
      <section class="card">
        <h3>Reset</h3>
